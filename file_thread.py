...
class Thread(QtCore.QThread):
    ...
    updateBar = QtCore.pyqtSignal(object,object)
    updateGraphs = QtCore.pyqtSignal(object,object,object,object)
    ...
    def run(self):
        ...
        """
        score, cost, score_test, cost_test, weights = self.net.SGD(self, self.arg[0], alpha=self.arg[1], keep_prob=self.arg[2], c=self.arg[3], lmbda=self.arg[4], learning_rate=self.arg[5], epoch=self.arg[6],
        monitor_training_accuracy=self.arg[7], monitor_training_cost=self.arg[8], monitor_evaluation_accuracy=self.arg[9], monitor_evaluation_cost=self.arg[10])
